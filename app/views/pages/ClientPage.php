...
<div class="container">
    <div class="row align-items-start align-items-md-center justify-content-end">
        <div class="col-md-5 text-center text-md-right pt-5 pt-md-0" style="margin-right: 20px;">
            <h1 class="mb-2 mx-lg-5">"Love pets, stop by now!"</h1>
            ...
            <div class="col-md-12">
                <div class="nonloop-block-3 owl-carousel owl-loaded owl-drag">
                    ...
                    <div class="owl-stage-outer"><div class="owl-stage" style="transform: translate3d(0px, 0px, 0px); transition: all 0s ease 0s; width: 1564px; padding-left: 15px; padding-right: 15px;"><div class="owl-item active" style="width: 286.667px; margin-right: 20px;"><div class="item">
                                ...
                                </div></div></div></div><div class="owl-nav"><div class="owl-prev disabled"><span class="icon-arrow_back"></span></div><div class="owl-next"><span class="icon-arrow_forward"></span></div></div><div class="owl-dots"><div class="owl-dot active"><span></span></div><div class="owl-dot"><span></span></div></div></div>
            </div>
        </div>
    </div>
</div>
